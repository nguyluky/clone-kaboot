...
export default function SessionDetail() {
    ...
    const [sessionDetail, setSessionDetail] = useState(/** @type {import('../../services/apiService').SessionDetail} */({}));
    ...
    const fetchSessionData = () => {
        setLoading(true);
        setError(null);
        api.session.getSessionDetail(sessionId || '')
    ...
    const timeAnalysisData = {
        labels: sessionDetail.questions.map((_, index) => `Question ${index + 1}`),
        datasets: [
            {
                label: 'Average Response Time (seconds)',
                data: sessionDetail.questions.map(q => q.avgResponseTime),
    ...
    //             label: 'Answers',
    //             data: [
    //                 sessionDetail.questions.reduce((sum, q) => sum + q.correctPercentage, 0) / sessionDetail.questions.length,
    //                 100 - (sessionDetail.questions.reduce((sum, q) => sum + q.correctPercentage, 0) / sessionDetail.questions.length),
    //             ],
    //             backgroundColor: [
    //                 'rgba(75, 192, 192, 0.6)',
    //                 'rgba(255, 99, 132, 0.6)',
            ...
            <div className="session-detail-header">
                <div className="session-detail-title">
                    ...
                    <p className="session-detail-meta">
                        {sessionDetail.created} • Duration: {sessionDetail.stats.completionRate}
                    </p>
                    <div className="session-quiz-info">
                        <span className="session-quiz-tag">Quiz: {sessionDetail.quiz}</span>
                        <span className="session-host-tag">Host: CYBERSOFT</span>
                    </div>
                </div>
            ...
            <div className="session-detail-summary">
                <div className="summary-card">
                    ...
                    <div className="summary-info">
                        <h3>{sessionDetail.stats.totalParticipants}</h3>
                        <p>Participants</p>
                    </div>
                </div>
                ...
                <div className="summary-card">
                    ...
                    <div className="summary-info">
                        <h3>{sessionDetail.stats.avgScore}%</h3>
                        <p>Average Score</p>
                    </div>
                </div>
                ...
                <div className="summary-card">
                    ...
                    <div className="summary-info">
                        <h3>{sessionDetail.stats.avgTimePerQuestion}s</h3>
                ...
                <div className="summary-card">
                    ...
                    <div className="summary-info">
                        <h3>{sessionDetail.stats.completionRate}%</h3>
                        <p>Completion Rate</p>
                    </div>
                </div>
            </div>
                    ...
                    <div className="session-overview">
                        ...
                        <div className="overview-section">
                            ...
                            <div className="top-performers">
                                {sessionDetail.participants.slice(0, 3).map(participant => (
                                    <div className="performer-card" key={participant.id}>
                                        ...
                                        <div className="performer-info">
                                            ...
                                            <div className="performer-stats">
                                                ...
                                                <span>{participant.incorrectAnswers} incorrect</span>
                                            </div>
                                        </div>
                                    </div>
                                ))}
                                ...
                                <tbody>
                                    {sessionDetail.participants.map(participant => (
                                        <tr key={participant.id}>
                                            ...
                                            <td>{participant.incorrectAnswers}</td>
                                            <td>
                                                <button
                                ...
                                <div className="question-analysis-card" key={question.id}>
                                    ...
                                    <div className="question-analysis-content">
                                        <div className="correct-answer">
                                            <span>Correct Answer:</span> {question.distribution.find(option => option.isCorrect)?.answer}
                                        </div>
                                                ...
                                                <div className="answer-option" key={option.answer}>
                                                    ...
                                                    <div className="answer-bar-container">
                                                        <div
                                                            ...
                                                            style={{ width: `${(option.count / sessionDetail.stats.totalParticipants) * 100}%` }}
                                                        ></div>
                                                    </div>
                                                </div>
                                            ))}
